...
class UnitTests(unittest.TestCase):
    ...
    def test_deposit(self):
        ...
        actual = self.food.name1[0]
        expected = {"amount": 900, "description": "deposit"}
        self.assertEqual(actual, expected, 'Expected `deposit` method to create a specific object in the name1 instance variable.')
    ...
    def test_withdraw(self):
        ...
        actual = self.food.name1[1]
        expected = {"amount": -45.67, "description": "milk, cereal, eggs, bacon, bread"}
        self.assertEqual(actual, expected, 'Expected `withdraw` method to create a specific object in the name1 instance variable.')
    ...
    def test_transfer(self):
        ...
        actual = self.food.name1[2]
        expected = {"amount": -transfer_amount, "description": "Transfer to Entertainment"}
        self.assertEqual(actual, expected, 'Expected `transfer` method to create a specific name1 item in food object.')
        ...
        actual = self.entertainment.name1[0]
        expected = {"amount": transfer_amount, "description": "Transfer from Food"}
        self.assertEqual(actual, expected, 'Expected `transfer` method to create a specific name1 item in entertainment object.')
